...
const SuperAdminProfileLayer = () => {
    ...
    const EditAdmin = async () => {
        ...
        setLoading(true);
        try {
            const res = await apiPost("superadmin/profile-update", data);
            if (res?.data?.status === true) {
    ...
    const ChangeAdminPassword = async () => {
        ...
        try {
            const res = await apiPost("superadmin/change-password", data); 
            console.log(res);
            if (res?.data?.status === true) {
...
export default SuperAdminProfileLayer;
